...
class EsdevenimentsModel{
  factory EsdevenimentsModel(){
    return _instance;
  }
  EsdevenimentsModel._constructor(){
  }
  static EsdevenimentsModel _instance = EsdevenimentsModel._constructor();
  static List<Esdeveniment> _esdeveniments = <Esdeveniment>[
  Esdeveniment(
  ...
  static List<Esdeveniment> get esdeveniments => _esdeveniments!;

  static set esdeveniments(List<Esdeveniment> value) {
    _esdeveniments = value;
  }
  void addEvent(Esdeveniment e){
    esdeveniments.add(e);
  }
  void popEvent(Esdeveniment e){
